...
(function () {
  ...
  function bindDumpButton() {
    ...
    function addItems(locations, hot) {

    //var base_url = "create/add/pricelists";
    console.log(base_url);

    
    $.ajaxSetup({ headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') } });
      $.ajax({
        url: base_url+"/discounts/pricelists/create/add/pricelists",
        type: "POST",  
        dataType: "json",
        ...
        success : function(data) {
            ...
            if(result) {
              ...
              window.location.href = base_url+"/discounts/pricelists";
            }
         },
