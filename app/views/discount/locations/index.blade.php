                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-title">
                            <div class="title">Location info <a href="{{ url('discounts/excel/locations') }}"><i class=" glyphicon glyphicon-download-alt"></i></a></div>
                        </div>
                    </div>
                    <div class="card-body">
                        @if(Auth::user()->role[0]->rolename == 'Discount-Data User')
                            ...
                            ->setUrl(route('api.locations'))   // this is the route where data will be retrieved
                            ->render() }}
                        @else
                            {{ Datatable::table()
