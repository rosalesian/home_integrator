           ...
           <div class="container-fluid">
            <div class="side-body">
              <div class="row">
                  <div class="content">
                    <div class="row">
                        <button name="dump" data-dump="#example5" data-instance="hot5" title="Prints current data source to Firebug/Chrome Dev Tools" class="btn btn-info">Add Location
                        </button>
                            ...
                            <div class="columnLayout">
                              ...
                              <script data-jsfiddle="example5">
                                var
                                  ...
                                  colWidths: [300, 300],
                                  columnSorting: true,
                                  colHeaders: ['Location Name', 'Reference'],
                                  rowHeaders: true,
                                  columns: [
                                    {data: 'name'},
                                    {data: 'reference'}
