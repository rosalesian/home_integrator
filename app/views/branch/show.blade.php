...
<h3 style="border-bottom:1px solid #666562;padding-bottom:10px; color:#666562; margin-bottom:0px;">Branch</h3>
	...
	<div class="row" style="margin-top:40px;">
		<div class="row" style="margin:15px; font-size:14px; color:#666562;">
			<div class="col-md-4">
				<div class="input-group">
					...
					<div id="name">{{ $branch->branchname }}</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="input-group">
		...
		<div class="row" style="margin:15px; font-size:14px; color:#666562;">
			<div class="col-md-4">
				<div class="dropdown">
					{{ HTML::link('branch/'.$branch->branch_id.'/edit','Edit', array('id'=>'submit','class'=>'btn btn-success custom-submit-button','style'=>'width:120px; padding-top:7px; padding-bottom:7px; margin:10px 5px 10px 0px;')) }}
				...
				<li>{{ HTML::link('branch/create','New') }}</li>
				<li>{{ HTML::link('branch','Lists') }}</li>
				</ul>
				</div>
			</div>	
		</div>
