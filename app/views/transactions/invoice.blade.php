		...
		<div class="row">
  		<div class="col-md-12">
  			<div class="log-container">
  				{{-- <input type="date" id="dateInvoice" style="margin: 2% 0% 2% 1%; width:21.3%"> --}}
		  		<input type="text" id="searchInvoice" placeholder=" SEARCH UPLOADED DATA" style="padding: 8px 0px 8px 0px; margin: 2% 0% 2% 1%; width:21.3%">
			  			...
			  			@if(count($invoices)>0)
				  			...
				  			<tr>
					  			<td style="text-align:center; width: 90px;">
									...
									@endif
					  				<a href="{{ Config::get('netsuite.invoice').$val->record_internal_id }}">view</a>
					  			</td>
				  			...
				  			@endforeach
				  				<tr>
				  					<td colspan="10" style="text-align:center;">{{ $invoices->links() }}</td>
				  				</tr>
				  		@else
